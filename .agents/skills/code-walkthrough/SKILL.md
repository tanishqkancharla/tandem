...
description: Keep a living spec that shows what's planned versus already in the tree, serve it with diffmap, and keep it updated. Use when explaining landed changes, or whenever generate-spec would apply.
---
